...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row" style="font-size: 12px;">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <div class="row">
                                                            <input type="text" id="producto_id" class="form-control" hidden>
                                                            <div class="col-md-4">
                                        ...
                                        <div class="row" style="font-size: 12px;">
                                            <div class="row">
                                                <input type="text" id="proveedor_id" class="form-control" hidden>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label>CUIL:</label>
                            ...
                            <div class="col-md-12">
                                <div class="card card-outline card-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="num_compra" style="text-align: center;" class="form-control" value="<?php echo $contador_num_compra; ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="hidden" id="usuario_id" value="<?php echo $id_usuarios; ?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button id="guardar-compra" class="btn btn-primary btn-block">Guardar compra</button>
                                                <br>
                ...
                <div id="respuesta-compra">kkjkj</div>
        </div>
    </div>
</div>
...
<script>
    ...
    $('#guardar-compra').click(function()
    {
        ...
        {
            var url = "../app/controllers/compras/create_compras.php";
